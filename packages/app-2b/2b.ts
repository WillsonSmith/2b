...
import {
  createProvider,
  defaultModel,
} from "@2b/framework/providers/llm/createProvider.ts";
import { MemoryPlugin } from "@2b/framework/plugins/MemoryPlugin.ts";
import { SubAgentPlugin } from "@2b/framework/plugins/SubAgentPlugin.ts";
...
import { createCodebaseExplainerAgent } from "@2b/framework/agents/sub-agents/createCodebaseExplainerAgent.ts";
import { ScratchPlugin } from "@2b/framework/plugins/ScratchPlugin.ts";
...
import { ShellPlugin } from "@2b/framework/plugins/ShellPlugin.ts";
import { VerificationPlugin } from "@2b/framework/plugins/VerificationPlugin.ts";
import { RetryPlugin } from "@2b/framework/plugins/RetryPlugin.ts";
import { PlanPlugin } from "@2b/framework/plugins/PlanPlugin.ts";
import { DecisionPlugin } from "@2b/framework/plugins/DecisionPlugin.ts";
